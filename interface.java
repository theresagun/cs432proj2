...
public class prj1 {
        ...
        while(x == 1) {
                ...
                System.out.println("1 : Show Employees table.");
                System.out.println("2 : Show Customers table.");
                System.out.println("3 : Show Products table.");
                System.out.println("4 : Show Purchases table.");
                System.out.println("5 : Show Logs table.");
               ...
               int selection = sc1.nextInt();
                ...
                // If input == 1
                if(sc1 == 1) {
                        CallableStatement cs = conn.prepareCall("begin ? := refcursor_jdbc1.getemployees(); end;");
